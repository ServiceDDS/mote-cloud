 ...
 * @author JA Dianes
 */
public class DoubleDialView extends JPanel implements virtual_control_room.view.View {
    ...
    public DoubleDialView(int moteID1, int moteID2, String name1, String name2) {
        super(new BorderLayout());
        this.moteID1 = moteID1;
        this.moteID2 = moteID2;
        this.variable1 = name2;
        this.variable2 = name2;
