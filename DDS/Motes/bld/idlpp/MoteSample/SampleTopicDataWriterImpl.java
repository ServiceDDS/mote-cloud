...
public class SampleTopicDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements SampleTopicDataWriter
{
    private long copyCache;
    private SampleTopicTypeSupport typeSupport;

    public SampleTopicDataWriterImpl(MoteSample.SampleTopicTypeSupport ts)
    {
        typeSupport = ts;
