...
public class SampleTopicDataReaderImpl extends org.opensplice.dds.dcps.DataReaderImpl implements SampleTopicDataReader
{
    private long copyCache;
    private SampleTopicTypeSupport typeSupport;

    public SampleTopicDataReaderImpl(MoteSample.SampleTopicTypeSupport ts)
    {
        typeSupport = ts;
