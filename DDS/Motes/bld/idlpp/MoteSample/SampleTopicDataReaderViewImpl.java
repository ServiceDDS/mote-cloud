...
public class SampleTopicDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements SampleTopicDataReaderView
{
    private long copyCache;
    private SampleTopicTypeSupport typeSupport;

    public SampleTopicDataReaderViewImpl(MoteSample.SampleTopicTypeSupport ts)
    {
        typeSupport = ts;
