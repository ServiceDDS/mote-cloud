...
public class EventTopicDataReaderViewImpl extends org.opensplice.dds.dcps.DataReaderViewImpl implements EventTopicDataReaderView
{
    private long copyCache;
    private EventTopicTypeSupport typeSupport;

    public EventTopicDataReaderViewImpl(MoteSample.EventTopicTypeSupport ts)
    {
        typeSupport = ts;
